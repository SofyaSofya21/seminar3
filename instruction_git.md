...
Для того, чтобы загрузить сделанные изменения в удаленный репозиторий нужно использовать комманду 

    git push

## Выгрузка из удаленного репозитория осущестляется коммандой 
