...
## Загрузка новых изменения на удаленный репозиторий

Для того, чтобы загрузить сделанные изменения в удаленный репозиторий нужно использовать команду
    ...
    ## Команда переклюение между папками
